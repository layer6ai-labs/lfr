...
python main.py --method lfr --dataset epilepsy -a cnn\
        --num_targets 6  --target_layers 2 --num_of_classes 2\
        ...
        --fix_pred_lr --train-predictor-individually --pred_epochs 5 --pred_layers 1\
